...
"""
claude_bible_rag_v3.py — Claude 4.7 × FHL Bible Tools (agentic RAG engine)
==========================================================================
...
# Override without code changes: set FHL_MODEL_ID in .env (e.g. claude-opus-4-7
# to roll back to the slower but most capable tier).
MODEL_ID        = os.environ.get("FHL_MODEL_ID", "claude-sonnet-4-6")
MAX_TOOL_ROUNDS = 10
RESULT_PREVIEW  = 300
...
def bible_query(
    ...
    but ignored — Opus 4.7 rejects them with a 400 error.
    """
    def _log(msg: str):
        if log_callback:
            log_callback(msg)
