...
"""
claude_bible_rag_v4.py — Claude Sonnet 5 × FHL Bible Tools (agentic RAG engine)
===============================================================================
...
v4 (this file — used by the NEW FastAPI/React UI only; v3 stays in production
under the Gradio app):
...
Deployment: systemd user service `fhl-bible-bot.service`; app.py imports
this module (v1/v2 imports kept commented at app.py:29-31 for rollback).
...
def _linkify_all(text: str) -> str:
    """Post-process the final answer: verse links, then Strong's links."""
...
def bible_query(
    ...
    if stream_callback:
        ...
        return _linkify_all("".join(accumulated))
